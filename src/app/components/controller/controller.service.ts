...
export class ControllerService {
    ...
    currentController!: InteractionService;
    ...
    public createController(
        ...
        this.unitCreator = new UnitCreator(this.camera, this.objectManager.objects, this.scene);
        ...
        this.currentController = this.interactionService;
